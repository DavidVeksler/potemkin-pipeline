...
Sixteen distinct dramas, each a tidy crisis → the-agent-acts → recovery arc that
...
- **The script is a generator.** Every mission and boss drama is a JS generator
  ...
  passes its due time. ~14 event constructors compose **22 scripted dramas** (6 ambient
  + 16 boss) on top of a never-ending stream of fake missions.
